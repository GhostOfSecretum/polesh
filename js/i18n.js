...
window.POLESH_I18N = {
  ru: {
    ...
    "contact.error.send": "Не удалось отправить. Напишите напрямую: polesh.pro@yandex.ru",
  ...
  en: {
    ...
    "contact.error.send": "Could not send. Email me directly: polesh.pro@yandex.ru",
